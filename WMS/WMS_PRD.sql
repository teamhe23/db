...
select * from edsr.wms_rcv_asn_hdr where hdr_group_nbr in (4639);
select * from edsr.wms_rcv_asn_hdr where SHIPMENT_NBR = 'NAC000908761';
select * from edsr.wms_rcv_asn_dtl where po_nbr = '108902';
